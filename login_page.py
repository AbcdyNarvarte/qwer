...
from global_func import get_credentials, send_email_with_attachment, load_credentials_if_logged_in
    ...
    def lp_nb_btn(self):
      ...
      bg_color='transparent', font=("Futura", 15, 'bold')).place(x=215, y=150)
        ...
        CTkButton(self, text='EMAIL LOGIN', font=("futura", 12, 'bold'), width=120, height=30, bg_color='white',
                  fg_color='blue', corner_radius=10, border_width=2, border_color='black', command=lambda: get_credentials(self.controller)).place(x=650, y=545)

        self.forgot_pass = CTkButton(self, text='FORGOT PASSWORD?', font=("futura", 12, 'bold'), width=80, height=30, bg_color='white',
