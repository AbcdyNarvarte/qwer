...
class UserSet(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.sett_info.propagate = False  # Prevent propagation to root logger
        # Create and add file handler for settings info
        settings_handler = logging.FileHandler('C:/capstone/log_f/settings.log', mode='a')
        ...
        self.sett_info.info(f"Settings page initialized for user: {self.controller.session.get('user_id', 'unknown')}")
        ...
        warning_handler = logging.FileHandler('C:/capstone/log_f/settings.log', mode='a')
        ...
        error_handler = logging.FileHandler('C:/capstone/log_f/settings.log', mode='a')
        ...
        logout_handler = logging.FileHandler('C:/capstone/log_f/login.log', mode='a')
